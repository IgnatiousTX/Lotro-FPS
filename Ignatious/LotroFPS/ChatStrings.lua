...
local chatStrings = {
	...
	horn = {
		...
		playerName .. " applied a benefit with Belly of Brine",
			playerName .. " applied a critical benefit with Call to Arms",
			playerName .. " applied a critical benefit with Make Haste",
			playerName .. " applied a critical benefit with Belly of Brine",
	},
	shout = {
	...
	shoutB = {
		...
		playerName .. " applied a benefit with Re-centre",
			playerName .. " applied a critical benefit with Sea Legs",
			playerName .. " applied a critical benefit with Re-centre",
